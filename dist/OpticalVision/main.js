...
/* harmony import */ var _main_load_main_load_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./main-load/main-load.module */ "./src/app/main-load/main-load.module.ts");
/* harmony import */ var _top_menu_top_menu_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./top-menu/top-menu.module */ "./src/app/top-menu/top-menu.module.ts");
...
/* harmony import */ var _guards_token_interceptor_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./guards/token-interceptor.service */ "./src/app/guards/token-interceptor.service.ts");
/* harmony import */ var _models_data__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./models/data */ "./src/app/models/data.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _main_load_main_load_module__WEBPACK_IMPORTED_MODULE_5__["MainLoadModule"],
                _top_menu_top_menu_module__WEBPACK_IMPORTED_MODULE_6__["TopMenuModule"],
                _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"],
                angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_11__["MDBBootstrapModule"].forRoot()
            ],
            providers: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"], _models_data__WEBPACK_IMPORTED_MODULE_10__["Data"], {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"],
                    useClass: _guards_token_interceptor_service__WEBPACK_IMPORTED_MODULE_9__["TokenInterceptorService"],
                    multi: true
                }],
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function () {
        if (_utils__WEBPACK_IMPORTED_MODULE_2__["Utils"].loggedIn()) {
            return true;
        }
        else {
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.getUserName = function () {
        return this.httpClient.get("" + _utils__WEBPACK_IMPORTED_MODULE_2__["Utils"].getUserNameURL(), {
        // observe: 'body',
...
var SidemenuComponent = /** @class */ (function () {
    function SidemenuComponent(loginservice) {
    ...
    SidemenuComponent.prototype.ngOnInit = function () {
        ...
        this.loginservice.getUserName().subscribe(function (data) {
            ...
            if (data.Identifier === _this.admin) {
...
var COMPANY_URL = API_URL + "api/visionapp/company/";
var REGISTER_ACTION = 'register';
var ADMIN_LOGIN_ACTION = 'adminlogin';
var EMPLOYEE_LOGIN_ACTION = 'employeelogin';
...
var Utils = /** @class */ (function () {
    ...
    Utils.updateSignupURL = function () {
...
module.exports = __webpack_require__(/*! D:\PaalanAngularProjects\GithubProject\OpticalVisionApp-Angular\src\main.ts */"./src/main.ts");
